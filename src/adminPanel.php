...
<head>
    ...
    <style>
        ...
        h2.hover-effect {
            ...
            /* Transición suave para el color y la opacidad */
            cursor: pointer;
        }
        ...
        h2.hover-effect.hidden {
            opacity: 0;
            /* Ocultar el texto estableciendo la opacidad en 0 */
        }
...
<body>
    ...
    <h2 class="hover-effect" onmouseover="changeText(this)" onmouseout="revertText(this)" onclick="redirectHome(this)">
        Panel de Administración</h2>
    <!-- Contenedor de los iframes para crear y editar anuncios -->
    <div class="responsive">
        <!-- Iframe para crear anuncios -->
        <iframe id="crearAnunciosFrame" src="crearAnuncios.php" width="50%" height="600px"
            style="border: none;"></iframe>
        <!-- Iframe para editar anuncios -->
        <iframe id="editarAnunciosFrame" src="editarAnuncios.php" width="50%" height="600px"
            style="border: none;"></iframe>
    </div>
